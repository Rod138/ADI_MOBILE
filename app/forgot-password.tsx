...
import { BackButton, SectionCard, StatusBanner } from "@/components/ui";
import { Colors } from "@/constants/colors";
import { useAuth } from "@/hooks/useAuth";
import { MAX_EMAIL_LENGTH, validateEmail } from "@/utils/validators";
        ...
        <View style={styles.root}>
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    >
                        <BackButton label="Volver al inicio de sesión" onPress={() => router.back()} />

                        {/* Header */}
                        <View style={styles.headerSection}>
                            <View style={styles.iconRing}>
                                <View style={styles.iconInner}>
                                    <Ionicons name="lock-open-outline" size={30} color={Colors.primary.light} />
                                </View>
                            </View>
                            ...
                            <View style={styles.taglineRow}>
                                ...
                                <Text style={styles.taglineText}>
                                    {step === "input" ? "Te enviaremos instrucciones" : "Revisa tu bandeja de entrada"}
                                </Text>
                                <View style={styles.taglineLine} />
                            </View>
                        </View>
                        ...
                        <View style={styles.formSection}>
                            <SectionCard>
                                ...
                                {step === "success" && (
                                    <SuccessContent email={email} onResend={handleSubmit} isLoading={isLoading} />
                                )}
                            </SectionCard>
...
function SuccessContent({ email, onResend, isLoading }: { email: string; onResend: () => void; isLoading: boolean }) {
    return (
        <View style={styles.successContainer}>
            ...
            <StatusBanner type="info" message="Revisa también tu carpeta de spam o correo no deseado." />
            ...
            <TouchableOpacity onPress={() => router.push("/login")} activeOpacity={0.7} style={styles.returnBtn}>
