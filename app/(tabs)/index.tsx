                            ...
                            {statuses.map((s) => {
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        style={[styles.statusTab, isActive && { borderColor: ss.border, backgroundColor: ss.bg }]}
                                        activeOpacity={0.7}
                                    >
                                        <Ionicons name={ss.icon} size={13} color={isActive ? ss.color : "rgba(255,255,255,0.35)"} style={{ marginRight: 5 }} />
                                        <Text style={[styles.statusTabText, isActive && [styles.statusTabTextActive, { color: ss.color }]]}>
                                            {s.name}
                                        </Text>
                                    </TouchableOpacity>
                                );
                    ...
                    <Animated.View style={[styles.drawer, { transform: [{ translateX: drawerAnim }] }]}>
                        <SafeAreaView style={styles.drawerSafe}>
                            ...
                            <ScrollView showsVerticalScrollIndicator={false}>
                                ...
                                >
                                    <Ionicons name="apps-outline" size={18} color={activeAreaId === undefined ? Colors.primary.light : "rgba(255,255,255,0.55)"} />
                                    <Text style={[styles.drawerItemText, activeAreaId === undefined && styles.drawerItemTextActive]}>
                                        Todas las áreas
                                    </Text>
                                    {activeAreaId === undefined && <Ionicons name="checkmark" size={16} color={Colors.primary.light} style={{ marginLeft: "auto" }} />}
                                </TouchableOpacity>
                                {areas.map((area) => (
                                    <TouchableOpacity
                                        key={area.id}
                                    ...
                                    >
                                        <Ionicons name="grid-outline" size={18} color={activeAreaId === area.id ? Colors.primary.light : "rgba(255,255,255,0.55)"} />
                                        <Text style={[styles.drawerItemText, activeAreaId === area.id && styles.drawerItemTextActive]}>
                                            {area.name}
                                        </Text>
                                        {activeAreaId === area.id && <Ionicons name="checkmark" size={16} color={Colors.primary.light} style={{ marginLeft: "auto" }} />}
                                    </TouchableOpacity>
                                ))}
                            </ScrollView>
                        </SafeAreaView>
...
const cardStyles = StyleSheet.create({
    card: { flexDirection: "row", backgroundColor: "rgba(255,255,255,0.06)", borderRadius: 20, borderWidth: 1, borderColor: "rgba(255,255,255,0.10)", marginBottom: 12, overflow: "hidden" },
    statusBar: { width: 4 },
    inner: { flex: 1, padding: 14 },
    topRow: { flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 10 },
    avatarCircle: { width: 38, height: 38, borderRadius: 19, backgroundColor: "rgba(59,130,246,0.20)", borderWidth: 1, borderColor: "rgba(59,130,246,0.30)", alignItems: "center", justifyContent: "center", flexShrink: 0 },
    ...
    statusBadge: { flexDirection: "row", alignItems: "center", gap: 5, borderWidth: 1, borderRadius: 20, paddingHorizontal: 9, paddingVertical: 5, flexShrink: 0 },
    ...
    metaChip: { flexDirection: "row", alignItems: "center", gap: 5, backgroundColor: "rgba(59,130,246,0.10)", borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4, borderWidth: 1, borderColor: "rgba(59,130,246,0.20)" },
    ...
    description: { fontFamily: "Outfit_400Regular", fontSize: 13, color: "rgba(255,255,255,0.72)", lineHeight: 20, marginBottom: 10 },
    image: { width: "100%", height: 160, borderRadius: 12, marginBottom: 10 },
    footer: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.07)", paddingTop: 8 },
...
const styles = StyleSheet.create({
    ...
    blobTR: { position: "absolute", top: -60, right: -70, width: 220, height: 220, borderRadius: 110, backgroundColor: "rgba(59,130,246,0.12)" },
    blobBL: { position: "absolute", bottom: 100, left: -60, width: 180, height: 180, borderRadius: 90, backgroundColor: "rgba(109,40,217,0.10)" },
    safeArea: { flex: 1 },
    ...
    statusTab: { flexDirection: "row", alignItems: "center", paddingHorizontal: 13, paddingVertical: 7, borderRadius: 20, borderWidth: 1, borderColor: "rgba(255,255,255,0.10)", backgroundColor: "rgba(255,255,255,0.05)" },
    statusTabAllActive: { borderColor: "rgba(59,130,246,0.45)", backgroundColor: "rgba(59,130,246,0.15)" },
    ...
    activeFilterBanner: { flexDirection: "row", alignItems: "center", gap: 6, marginHorizontal: 16, marginTop: 8, paddingHorizontal: 12, paddingVertical: 7, backgroundColor: "rgba(59,130,246,0.12)", borderRadius: 10, borderWidth: 1, borderColor: "rgba(59,130,246,0.25)" },
    ...
    drawer: { position: "absolute", top: 0, bottom: 0, right: 0, width: DRAWER_WIDTH, backgroundColor: "#0F2470", borderLeftWidth: 1, borderLeftColor: "rgba(255,255,255,0.09)", shadowColor: "#000", shadowOffset: { width: -8, height: 0 }, shadowOpacity: 0.45, shadowRadius: 20, elevation: 20 },
    drawerSafe: { flex: 1, paddingTop: Platform.OS === "android" ? 40 : 0 },
    drawerHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 20, paddingVertical: 18, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.08)" },
    drawerTitle: { fontFamily: "Outfit_700Bold", fontSize: 16, color: "#FFFFFF" },
    drawerItem: { flexDirection: "row", alignItems: "center", gap: 12, paddingHorizontal: 20, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.05)" },
