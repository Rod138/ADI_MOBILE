...
import { ScreenShell, SectionCard } from "@/components/ui";
...
export default function CreateIncidentScreen() {
    ...
    const handleSubmitPress = () => { if (!validate()) return; setShowConfirm(true); };
    ...
    const handleConfirm = async () => {
        ...
        const payload = { description: description.trim(), image: imageUrl, usr_id: user!.id, area_id: areaId!, type_id: typeId!, status_id: defaultStatus, cost: 0 };
    ...
    return (
        <ScreenShell scroll scrollPaddingH={20} scrollContentStyle={{ gap: 20 }}>
            {/* Header */}
            ...
            <SectionCard>
                ...
                <View style={styles.fieldWrapper}>
                    ...
                    <View style={[styles.textAreaContainer, descFocused && styles.textAreaFocused, fieldErrors.description ? styles.textAreaError : null]}>
                        <Ionicons name="document-text-outline" size={18} color={descFocused ? "rgba(255,255,255,0.85)" : "rgba(255,255,255,0.40)"} style={styles.textAreaIcon} />
                        <TextInput
            ...
            <Modal visible={showConfirm} transparent animationType="fade" onRequestClose={() => setShowConfirm(false)}>
                <View style={modalStyles.overlay}>
                    <View style={modalStyles.sheet}>
                        ...
                        <Text style={modalStyles.body}>Asegúrate de que los datos sean correctos. Si son incorrectos, la solución puede tardar más.</Text>
                        <View style={modalStyles.actions}>
                            <TouchableOpacity style={[modalStyles.btn, modalStyles.btnCancel]} onPress={() => setShowConfirm(false)}>
            ...
            <Modal visible={showSuccess} transparent animationType="fade" onRequestClose={() => setShowSuccess(false)}>
                <View style={modalStyles.overlay}>
                    <View style={modalStyles.sheet}>
                        ...
                        <Text style={modalStyles.body}>La incidencia fue reportada con éxito. El equipo de administración la revisará pronto.</Text>
                        <TouchableOpacity
...
const pickerStyles = StyleSheet.create({
    ...
    label: { fontFamily: "Outfit_700Bold", fontSize: 11, color: "rgba(255,255,255,0.65)", letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 8 },
    trigger: { flexDirection: "row", alignItems: "center", height: 54, borderRadius: 14, paddingHorizontal: 16, borderWidth: 1.5, borderColor: "rgba(255,255,255,0.18)", backgroundColor: "rgba(255,255,255,0.07)" },
    ...
    modalSheet: { backgroundColor: "#0F2470", borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingBottom: 32, maxHeight: "70%", borderTopWidth: 1, borderTopColor: "rgba(255,255,255,0.10)" },
    sheetHandle: { width: 36, height: 4, borderRadius: 2, backgroundColor: "rgba(255,255,255,0.20)", alignSelf: "center", marginTop: 12, marginBottom: 8 },
    sheetTitle: { fontFamily: "Outfit_700Bold", fontSize: 16, color: Colors.white, paddingHorizontal: 20, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.08)" },
    option: { flexDirection: "row", alignItems: "center", paddingHorizontal: 20, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.05)" },
    ...
    cancelBtn: { marginHorizontal: 20, marginTop: 12, paddingVertical: 14, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.08)", alignItems: "center" },
...
const modalStyles = StyleSheet.create({
    ...
    sheet: { width: "100%", backgroundColor: "#0F2470", borderRadius: 28, padding: 28, alignItems: "center", borderWidth: 1, borderColor: "rgba(255,255,255,0.10)", gap: 14 },
    iconCircle: { width: 72, height: 72, borderRadius: 36, backgroundColor: "rgba(217,119,6,0.14)", borderWidth: 1.5, borderColor: "rgba(217,119,6,0.35)", alignItems: "center", justifyContent: "center" },
...
const styles = StyleSheet.create({
    ...
    fieldLabel: { fontFamily: "Outfit_700Bold", fontSize: 11, color: "rgba(255,255,255,0.65)", letterSpacing: 1.2, textTransform: "uppercase", marginBottom: 8 },
    textAreaContainer: { flexDirection: "row", borderRadius: 14, paddingHorizontal: 16, paddingVertical: 12, borderWidth: 1.5, borderColor: "rgba(255,255,255,0.18)", backgroundColor: "rgba(255,255,255,0.07)", minHeight: 110 },
    ...
    textArea: { flex: 1, fontFamily: "Outfit_400Regular", fontSize: 15, color: Colors.white, textAlignVertical: "top", minHeight: 86 },
    errorRow: { flexDirection: "row", alignItems: "center", marginTop: 6, gap: 4 },
    errorText: { fontFamily: "Outfit_500Medium", fontSize: 12, color: "#FCA5A5" },
    imageSection: { marginBottom: 18 },
    imagePicker: { height: 110, borderRadius: 14, borderWidth: 1.5, borderColor: "rgba(255,255,255,0.14)", borderStyle: "dashed", backgroundColor: "rgba(255,255,255,0.04)", alignItems: "center", justifyContent: "center", gap: 6 },
    ...
    costRow: { flexDirection: "row", alignItems: "center", gap: 8, paddingVertical: 12, paddingHorizontal: 16, backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 12, marginBottom: 20, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
