        ...
        <View style={[styles.accordionItem, !isLast && styles.accordionItemBorder]}>
            ...
            >
                <View style={styles.accordionAnswerWrap}>
                    <View style={[styles.answerAccentLine, { backgroundColor: Colors.primary.main }]} />
...
function getAreaIcon(areaName: string): keyof typeof Ionicons.glyphMap {
    ...
    if (n.includes("elevad") || n.includes("ascens")) return "arrow-up-circle-outline";
    if (n.includes("estacion") || n.includes("parking")) return "car-outline";
    if (n.includes("alberca") || n.includes("piscin") || n.includes("gym") || n.includes("amenidad")) return "fitness-outline";
    if (n.includes("seguridad") || n.includes("acceso")) return "shield-outline";
    if (n.includes("pago") || n.includes("cuota") || n.includes("financ")) return "wallet-outline";
    if (n.includes("incidencia") || n.includes("reporte")) return "warning-outline";
...
function getAreaAccent(index: number) {
    const accents = [
        { color: Colors.primary.main, bg: Colors.primary.soft, border: Colors.primary.muted, dark: Colors.primary.dark },
        { color: Colors.secondary.main, bg: Colors.secondary.soft, border: "#FED7AA", dark: "#C2410C" },
        { color: "#0891B2", bg: "#F0F9FF", border: "#BAE6FD", dark: "#0E7490" },
        { color: "#7C3AED", bg: "#F5F3FF", border: "#DDD6FE", dark: "#6D28D9" },
        { color: Colors.status.success, bg: Colors.status.successBg, border: Colors.status.successBorder, dark: "#15803D" },
    ];
    ...
    return (
        <View style={styles.areaGroup}>
            ...
            <View style={styles.areaHeader}>
                <View style={[styles.areaIconWrap, { backgroundColor: accent.bg, borderColor: accent.border }]}>
                    <Ionicons name={icon} size={18} color={accent.color} />
                </View>
                <View style={styles.areaTitles}>
                    <Text style={[styles.areaName, { color: accent.dark }]}>{group.area.name}</Text>
                ...
                <View style={[styles.areaCountBadge, { backgroundColor: accent.bg, borderColor: accent.border }]}>
        ...
        <Animated.View style={[styles.skeletonGroup, { opacity }]}>
            <View style={styles.skeletonHeader}>
                ...
                <View style={styles.skeletonTitleWrap}>
                    ...
                    <View style={[styles.skeletonLine, { width: "80%", height: 10, marginTop: 5 }]} />
                </View>
            </View>
            <View style={styles.skeletonCard}>
                {[1, 2, 3].map((k) => (
                    <View key={k} style={[styles.skeletonRow, k < 3 && styles.skeletonRowBorder]}>
                        <View style={[styles.skeletonLine, { width: `${60 + k * 10}%` as any, height: 11 }]} />
                    </View>
                ))}
            </View>
        </Animated.View>
...
function ReportCard({ onPress }: { onPress: () => void }) {
    ...
    return (
        <Animated.View style={[styles.reportCardWrap, { transform: [{ scale: scaleAnim }] }]}>
            <TouchableOpacity
                ...
                <View style={styles.reportInner}>
                    <View style={styles.reportLeft}>
                        <View style={styles.reportIconWrap}>
                            <Ionicons name="bug-outline" size={24} color={Colors.status.error} />
                        </View>
                    ...
                    <View style={styles.reportArrow}>
                        <Ionicons name="arrow-forward" size={16} color={Colors.status.error} />
                    </View>
                </View>
            </TouchableOpacity>
        </Animated.View>
        ...
        <ScreenShell theme="light">
            ...
            {isLoading ? (
                ...
                <View style={styles.centered}>
                    ...
                    <TouchableOpacity onPress={fetchFaqs} style={styles.retryBtn} activeOpacity={0.8}>
                ...
                <View style={styles.centered}>
                    <View style={styles.emptyIconWrap}>
                        <Ionicons name="help-buoy-outline" size={36} color={Colors.screen.textMuted} />
                    </View>
                ...
                >
                    ...
                    <View style={styles.dividerSection}>
                        ...
                        <Text style={styles.dividerText}>¿NO ENCONTRASTE LO QUE BUSCAS?</Text>
                        <View style={styles.dividerLine} />
                    </View>
                    ...
                    <View style={styles.footer}>
                        <Ionicons name="shield-checkmark-outline" size={12} color={Colors.screen.textMuted} />
